			...
			<div className={'container ' + styles.bottom_container}>
				<div className={styles.left}>
					<div className={styles.tab_container}>
						<div onClick={() => setSubTab("events")} className={styles.link + " " + `${subTab === "events" ? styles.active : ""}`}>Events</div>
						<div onClick={() => setSubTab("posts")} className={styles.link + " " + `${subTab === "posts" ? styles.active : ""}`}>Posts</div>
						<div onClick={() => setSubTab("projects")} className={styles.link + " " + `${subTab === "projects" ? styles.active : ""}`}>Projects</div>
						<div onClick={() => setSubTab("blogs")} className={styles.link + " " + `${subTab === "blogs" ? styles.active : ""}`}>Blogs</div>
					</div>
